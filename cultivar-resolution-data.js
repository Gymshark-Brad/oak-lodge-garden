...
(() => {
  const RESOLUTIONS = {
    ...
    "bed2-weigela": { name: "Weigela ‘Prism Magic Carpet’ — label confirmed", latin: "Weigela florida ‘Prism Magic Carpet’", status: "confirmed", basis: "The retained Willowbrook Garden Centre label photographed in August 2026 explicitly reads Weigela Prism Magic Carpet." },
