...
(() => {
  const RESOLUTIONS = {
    ...
    "stone-stonecrop": { name: "Stonecrop ‘Angelina’ — assumed", latin: "Petrosedum rupestre ‘Angelina’", status: "assumed", basis: "Best fit from the trailing stems of narrow golden-green succulent leaves." },
    "stone-rosemary": { name: "Rosemary ‘Miss Jessopp’s Upright’ — assumed", latin: "Salvia rosmarinus ‘Miss Jessopp’s Upright’", status: "assumed", basis: "Best fit for the large, strongly upright established rosemary." },
    ...
    "frontBed5-climber-unidentified": { name: "Rambling Rose ‘Kiftsgate’ — assumed", latin: "Rosa filipes ‘Kiftsgate’", status: "assumed", basis: "The photographs show a thorny rose with seven-leaflet foliage and clustered spent blooms, not an unrelated climber; ‘Kiftsgate’ is the best rambler fit." },
