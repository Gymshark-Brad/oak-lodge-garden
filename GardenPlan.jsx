...
function GardenPlan({ onOpenZone, dark }) {
  ...
  const order = [
    ...
    "bigpot1", "bigpot2", "cercispot", "lobeliapot", "littlepot1", "littlepot2", "baskets", "wallpot1", "wallpot2",
  ];
    ...
    <div className="plan-wrap fade-in" style={{ position: "relative" }}>
      ...
      <div className="plan-legend">
        ...
        <div className="legend-grid">
          {["bed1", "bed2", "bed3", "bed4", "bed5", "stone", "patio", "steps", "lounge", "pear", "bigpot1", "bigpot2", "cercispot", "lobeliapot", "littlepot1", "littlepot2", "baskets", "wallpot1", "wallpot2"].map((k) => {
            const z = Z[k];
            return (
              <button
                key={k}
