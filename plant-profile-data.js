...
(() => {
  ...
  const profiles = {
    ...
    "bed2-weigela": {
      ...
      badges: ["Label confirmed", "Golden foliage", "Late-spring flowers"],
      description: "Weigela florida ‘Prism Magic Carpet’ is the compact Weigela in the middle of Flower Bed 2, with yellow-green foliage flushed bronze on young tips. Pink trumpet-shaped flowers open on short side shoots in late spring and early summer, while the coloured leaves keep the shrub useful beyond bloom. The cultivar is confirmed by the retained Willowbrook Garden Centre label photographed in August 2026.",
      floweringMonths: ["May", "Jun"],
      facts: [
        { label: "Size", value: "Compact shrub", detail: "Measure its mature height and spread at Oak Lodge" },
        ...
        { label: "Identity", value: "Weigela florida ‘Prism Magic Carpet’", detail: "Confirmed from a photographed nursery label" },
      ],
      careGuide: [
      ...
      seasons: [
        ...
        { season: "Summer", action: "Photograph the flower and whole shrub as it matures, then remove selected old stems and shorten obstructive shoots after bloom." },
      ...
      about: "Weigela are East Asian deciduous shrubs valued for tubular, pollinator-friendly flowers and an easy spreading habit. ‘Prism Magic Carpet’ brings a compact habit and bright golden foliage to the group, with pink flowers adding a short but valuable late-spring display.",
      provenanceNote: "Identity confidence: label confirmed. The retained Willowbrook Garden Centre label photographed in August 2026 supersedes the earlier assumed cultivar.",
      botanical: [
        { label: "Family", value: "Caprifoliaceae" }, { label: "Genus", value: "Weigela" },
        { label: "Botanical name", value: "Weigela florida ‘Prism Magic Carpet’" }, { label: "Plant type", value: "Deciduous shrub" },
        { label: "Native to Britain or Ireland", value: "No" }, { label: "Habit", value: "Bushy and spreading" },
        { label: "Time to mature", value: "5–10 years" }, { label: "Name status", value: "Label confirmed" },
      ],
      oakLodge: { location: "Middle section of Flower Bed 2 beside the wall", added: "Established before the 2026 journal", role: "Warm foliage mound and late-spring flower", observation: "Compact shrub with lime-gold leaves and bronze-flushed shoot tips; the Willowbrook label confirms ‘Prism Magic Carpet’.", status: "Keep the label photograph and record flowers, leaf underside, mature summer colour and full size as the shrub develops." },
