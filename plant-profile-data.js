...
(() => {
  ...
  const RHS = {
    ...
    bloodgood: {
      ...
      note: "Best-fit cultivar description, dimensions, cultivation and problems",
    },
    fatsia: {
    ...
    hostaPatriot: {
      ...
      note: "Cultivar description, dimensions, cultivation and hardiness",
    },
    box: {
    ...
    emeraldGold: {
      title: "Royal Horticultural Society · Euonymus ‘Emerald 'n' Gold’",
      url: "https://www.rhs.org.uk/plants/96928/euonymus-fortunei-emerald-n-gold-v/details",
      note: "Cultivar description, dimensions, cultivation, safety and problems",
    },
    dahlia: {
  ...
  const profiles = {
    "bed1-japanese-maple": {
      ...
      badges: ["Best-fit cultivar", "Architectural canopy", "Autumn colour"],
      description: "Best identified as Acer palmatum ‘Bloodgood’, this upright Japanese maple is the dominant canopy in Flower Bed 1. Its five- to seven-lobed leaves open deep red-purple, hold a dark wine colour through summer and brighten to scarlet in autumn. Small red spring flowers may be followed by winged fruits, but the lasting display is the dense purple foliage and graceful branching. The original label is missing, so ‘Bloodgood’ is recorded as a strong photographic best fit rather than a documented certainty.",
      floweringMonths: ["Apr", "May"],
      facts: [
        { label: "Size", value: "2.5–4m", detail: "Upright, bushy tree with a broadly rounded crown" },
        { label: "Position", value: "Sun or light shade", detail: "Shelter from drying wind and harsh afternoon heat" },
        ...
        { label: "Foliage", value: "Deep red-purple", detail: "Five- to seven-lobed leaves turn bright red in autumn" },
        { label: "Identity", value: "‘Bloodgood’ — best fit", detail: "Photo- and habit-based; no surviving plant label" },
      ],
      careGuide: [
      ...
      about: "‘Bloodgood’ is a widely grown purple-leaved selection of Acer palmatum. It forms an upright, bushy small tree with deeply divided leaves that remain dark red-purple for much of the growing season before becoming brighter red in autumn. That combination of sustained purple colour, broad upright habit and mature garden scale is the closest match to the Oak Lodge tree.",
      provenanceNote: "Identity confidence: medium-high. ‘Bloodgood’ is the best fit from the tree’s upright habit, size and season-long deep purple foliage, but it is not supported by a surviving label.",
      botanical: [
        { label: "Family", value: "Sapindaceae" }, { label: "Genus", value: "Acer" },
        { label: "Botanical name", value: "Acer palmatum ‘Bloodgood’ · best-fit identification" }, { label: "Plant type", value: "Small deciduous tree" },
        { label: "Native range", value: "Japan, central China and Korea" }, { label: "Foliage", value: "Deciduous; palmately lobed" },
        { label: "Time to mature", value: "10–20 years" }, { label: "Identity status", value: "Best fit; label not retained" },
      ],
      oakLodge: { location: "Back centre of Flower Bed 1", added: "Established before the 2026 journal", role: "Dominant canopy and seasonal focal point", observation: "The photographed tree has a broad upright crown and deep burgundy foliage that holds through summer before turning fiery red.", status: "Recorded as ‘Bloodgood’, with the best-fit qualification retained unless a label or purchase record is found." },
      sources: [RHS.bloodgood, OAK_SOURCE],
    },
    ...
    "bed1-hosta": {
      ...
      badges: ["Confirmed cultivar", "Shade foliage", "Summer flowers"],
      description: "‘Patriot’ forms a broad mound of dark green, ribbed leaves with bold, irregular cream-white margins. The pointed spring shoots expand into overlapping foliage that brightens the front-left of Bed 1, followed by pale lavender flower bells on upright stems in midsummer. The clean contrast is strongest in bright shade, provided its roots remain cool and evenly moist.",
      floweringMonths: ["Jul", "Aug"],
      facts: [
        { label: "Size", value: "Up to 55cm high", detail: "A mature clump can spread 50–100cm" },
        ...
        { label: "Foliage", value: "Dark green and cream", detail: "Broad, irregular pale margins become white in summer" },
        { label: "Identity", value: "Hosta ‘Patriot’", detail: "Cultivar confirmed for the Oak Lodge plant" },
      ],
      ...hostaShared,
      about: "‘Patriot’ is a sport of Hosta ‘Francee’, selected for its much broader and brighter leaf margin. New growth can open creamy yellow before the margin fades to cream-white, while the dark green centre remains strong. It is a medium, clump-forming hosta whose foliage supplies the main display and whose pale lavender flowers add height in midsummer.",
      provenanceNote: "Cultivar identity confirmed by the garden owner; the bold cream-white margins also match the recorded ‘Patriot’ characteristics.",
      botanical: [
        { label: "Family", value: "Asparagaceae" }, { label: "Genus", value: "Hosta" },
        { label: "Botanical name", value: "Hosta ‘Patriot’" }, { label: "Plant type", value: "Herbaceous perennial" },
        { label: "Foliage", value: "Deciduous; dark green with broad cream-white margins" }, { label: "Habit", value: "Clump-forming mound" },
        { label: "Flowers", value: "Pale lavender in midsummer" }, { label: "Propagation", value: "Division; seedlings do not remain true" },
      ],
      oakLodge: { location: "Front-left of Flower Bed 1", added: "Established before the 2026 journal", role: "Broad variegated foliage in shade", observation: "Dark green leaves carry the broad pale margins expected of ‘Patriot’; pale lavender flowers are recorded in July.", status: "Cultivar is now confirmed; track mature spread and slug damage rather than identity." },
      sources: [RHS.hostaPatriot, RHS.hosta, OAK_SOURCE],
    },
    ...
    "bed1-euonymus": {
      ...
      badges: ["Confirmed cultivar", "Year-round foliage", "Cold-weather colour"],
      description: "‘Emerald ’n’ Gold’ is a compact evergreen wintercreeper with small green leaves edged broadly in golden yellow. It forms a low spreading mound at the front-left of Bed 1, supplying colour throughout the year; exposed leaves often blush pink-red in cold weather. Its tiny early-summer flowers are inconspicuous, so the bright foliage and tidy groundcover habit are the real display.",
      floweringMonths: ["May", "Jun"],
      facts: [
        { label: "Size", value: "0.5–1m high", detail: "Spreads about 1–1.5m; can climb if supported" },
        ...
        { label: "Safety", value: "Harmful if eaten", detail: "Wear gloves and collect trimmings" },
      ],
      ...euonymusShared,
      caution: "All parts may be harmful if eaten. Wear gloves when pruning, collect cut material and prevent pets or children from chewing the foliage.",
      about: "Euonymus fortunei is an evergreen creeping or climbing shrub from East Asia. ‘Emerald ’n’ Gold’ is one of its compact golden-variegated selections, valued for broad yellow leaf margins that become pink-tinged in winter. Although normally used as groundcover or a low shrub, its stems can climb when they meet a wall or other support.",
      provenanceNote: "Cultivar identity confirmed by the garden owner and consistent with the plant’s green-and-gold evergreen foliage.",
      botanical: [
        { label: "Family", value: "Celastraceae" }, { label: "Genus", value: "Euonymus" },
        { label: "Botanical name", value: "Euonymus fortunei ‘Emerald ’n’ Gold’" }, { label: "Plant type", value: "Evergreen shrub" },
        { label: "Native range", value: "East Asia" }, { label: "Habit", value: "Low, spreading or climbing with support" },
        { label: "Foliage", value: "Evergreen; green with golden-yellow margins" }, { label: "Name status", value: "Accepted cultivar" },
      ],
      oakLodge: { location: "Front-left corner of Flower Bed 1", added: "Established before the 2026 journal", role: "Low golden foliage at the bed edge", observation: "Green-and-gold evergreen leaves develop pink tints during cold weather.", status: "Cultivar is confirmed; remove any plain green reverted shoots before they overtake the variegated growth." },
      sources: [RHS.emeraldGold, RHS.euonymus, OAK_SOURCE],
    },

    "bed1-wintercreeper": {
      version: 2,
      type: "White-variegated evergreen shrub",
      badges: ["Confirmed cultivar", "Spreading groundcover", "Winter pink tints"],
      description: "‘Emerald Gaiety’ is a bushy, spreading evergreen wintercreeper with small dark green leaves irregularly margined in white. It forms a pale-edged groundcover at the front-right of Bed 1 and often develops attractive pink tints during cold weather. The flowers are tiny and greenish; this plant earns its place through year-round foliage, winter colour and a naturally dense habit.",
      floweringMonths: ["May", "Jun"],
      facts: [
        { label: "Size", value: "0.5–1m high", detail: "Can spread 1–1.5m and climb against support" },
      ...
      ...euonymusShared,
      caution: "All parts may be harmful if eaten. Wear gloves when pruning, collect cut material and prevent pets or children from chewing the foliage.",
      about: "Euonymus fortunei is an evergreen creeping or climbing shrub from East Asia. ‘Emerald Gaiety’ is a compact white-margined cultivar whose foliage frequently flushes pink in winter. It is normally clipped or allowed to spread as groundcover, but stems can attach and climb when they reach a suitable support.",
      provenanceNote: "Cultivar identity confirmed by the garden owner and consistent with the plant’s white-margined foliage and winter pink colouring.",
      botanical: [
        { label: "Family", value: "Celastraceae" }, { label: "Genus", value: "Euonymus" },
        { label: "Botanical name", value: "Euonymus fortunei ‘Emerald Gaiety’" }, { label: "Plant type", value: "Evergreen spreading shrub" },
        { label: "Native range", value: "East Asia" }, { label: "Habit", value: "Spreading; may climb with support" },
        { label: "Foliage", value: "Evergreen; white-margined and winter-pink" }, { label: "Name status", value: "Accepted cultivar" },
      ],
      oakLodge: { location: "Front-right of Flower Bed 1", added: "Established before the 2026 journal", role: "Pale evergreen groundcover along the bed edge", observation: "White-and-green leaves develop pink tints in cold weather and spread low across the front.", status: "Cultivar is confirmed; remove plain green reversions and trim wandering stems only where they crowd neighbours." },
      sources: [RHS.emeraldGaiety, RHS.euonymus, OAK_SOURCE],
    },

    "bed1-dahlia": {
      version: 2,
      type: "Compact double-flowered tuberous perennial",
      badges: ["Best-fit cultivar", "Lilac-magenta flowers", "Dark foliage"],
      description: "Best identified as Dahlia Double Dreamy® Lilac, this compact plant combines very dark burgundy-green foliage with fully double, pompon-like flowers in lilac-magenta, their outer petals fading paler at the tips. It brings dense colour to the centre of Bed 1 from summer until frost without the height of a traditional border dahlia. The Double Dreamy match is strong from the flower form, foliage and its pairing with the yellow plant, but no original label survives.",
      floweringMonths: ["Jul", "Aug", "Sep", "Oct"],
      facts: [
        { label: "Size", value: "About 40–50cm", detail: "Compact, bushy habit with a similar spread" },
        { label: "Position", value: "Full sun", detail: "Warm and sheltered; support only if flower weight makes it lean" },
        { label: "Soil", value: "Fertile, moist, drained", detail: "Needs moisture in growth but not winter waterlogging" },
        { label: "Hardiness", value: "H3", detail: "Top growth dies at frost; protect tubers below about −5°C" },
        { label: "Flowers", value: "Lilac-magenta, fully double", detail: "Rounded, pompon-like blooms with paler petal tips" },
        { label: "Identity", value: "Double Dreamy® Lilac", detail: "Best fit from photographs; label not retained" },
      ],
      ...dahliaShared,
      about: "The Double Dreamy® series was bred as a compact group of dahlias with very dark foliage and full, rounded flowers. Named colours include Lilac, Gold, Red, Rose and Salmon. This plant’s cool magenta-lilac blooms, pale petal tips, burgundy foliage and compact habit fit the Lilac selection substantially better than the earlier open-centred ‘Bishop type’ description.",
      provenanceNote: "Identity confidence: medium-high. Double Dreamy® Lilac is the best fit from the photographed full flower form, colour, dark foliage, compact habit and matching yellow companion; it is not label-confirmed.",
      botanical: [
        { label: "Family", value: "Asteraceae" }, { label: "Genus", value: "Dahlia" },
        { label: "Botanical name", value: "Dahlia Double Dreamy® Lilac · best-fit identification" }, { label: "Plant type", value: "Tuberous herbaceous perennial" },
        { label: "Native genus range", value: "Mexico and Central America" }, { label: "Foliage", value: "Dark bronze; deciduous at frost" },
        { label: "Flower form", value: "Fully double and rounded" }, { label: "Identity status", value: "Best fit; label not retained" },
      ],
      oakLodge: { location: "Centre of Flower Bed 1", added: "2026 journal plant", role: "Dark foliage and cool-toned late-season flower", observation: "Photographs show compact bronze-black foliage and fully double magenta-lilac flowers with noticeably paler tips.", status: "Recorded as Double Dreamy® Lilac on a best-fit basis; keep the qualification unless its label or purchase record appears." },
      sources: [DOUBLE_DREAMY_SOURCE, RHS.dahlia, OAK_SOURCE],
    },

    "bed1-dahlia-yellow": {
      version: 2,
      type: "Compact double-flowered tuberous perennial",
      badges: ["Best-fit cultivar", "Golden flowers", "Dark foliage"],
      description: "Best identified as Dahlia Double Dreamy® Gold, this compact plant carries rounded, fully double golden-yellow flowers above almost black burgundy-green foliage. Added to Bed 1 in June 2026, it creates a vivid warm contrast beside the likely Double Dreamy® Lilac plant while repeating the same low, bushy habit and dark leaves. The paired planting and series traits make this a strong best fit, although the original label was not retained.",
      floweringMonths: ["Jul", "Aug", "Sep", "Oct"],
      facts: [
        { label: "Size", value: "About 40–50cm", detail: "Compact, bushy habit with a similar spread" },
        { label: "Position", value: "Full sun", detail: "Warm and sheltered; support only if flower weight makes it lean" },
        ...
        { label: "Hardiness", value: "H3", detail: "Top growth dies at frost; protect tubers below about −5°C" },
        { label: "Flowers", value: "Golden yellow, fully double", detail: "Rounded flowers from summer until frost" },
        { label: "Identity", value: "Double Dreamy® Gold", detail: "Best fit from photographs; label not retained" },
      ],
      ...dahliaShared,
      about: "The Double Dreamy® series combines compact growth, dark burgundy-green foliage and full pompon-shaped flowers in a small group of named colours. Gold is the yellow-flowered member. The Oak Lodge plant’s rounded golden blooms, very dark leaves, low habit and close pairing with a likely Double Dreamy® Lilac plant all support that identification.",
      provenanceNote: "Identity confidence: medium-high. Double Dreamy® Gold is the best fit from the photographed full golden flowers, dark foliage, compact habit and matching companion; it is not label-confirmed.",
      botanical: [
        { label: "Family", value: "Asteraceae" }, { label: "Genus", value: "Dahlia" },
        { label: "Botanical name", value: "Dahlia Double Dreamy® Gold · best-fit identification" }, { label: "Plant type", value: "Tuberous herbaceous perennial" },
        { label: "Native genus range", value: "Mexico and Central America" }, { label: "Foliage", value: "Dark bronze; deciduous at frost" },
        { label: "Flower form", value: "Fully double and rounded" }, { label: "Identity status", value: "Best fit; label not retained" },
      ],
      oakLodge: { location: "Centre of Flower Bed 1", added: "June 2026", role: "Dark foliage with bright golden late-season colour", observation: "June photographs show compact bronze-black foliage, rounded buds and fully double golden-yellow flowers.", status: "Recorded as Double Dreamy® Gold on a best-fit basis; label lifted tubers clearly so the paired plants remain distinct." },
      sources: [DOUBLE_DREAMY_SOURCE, RHS.dahlia, OAK_SOURCE],
    },
