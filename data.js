...
window.OAK = (function () {
  ...
  const ZONES = {
    ...
    frontBed5: {
      ...
      desc:
        "The whole area right of the steps — bounded by the patio's arrow-point diagonals, the timber steps' east edge, and the brick boundary wall. The established cherry laurel, golden Choisya, shrub rose, bay, skimmia, hardy fuchsia and clematis share the bed with heathers, Pittosporum, Gaura, Sollya, Ceratostigma, Hypericum, Hebe and Salvia. August brought the moved Astrantia trio and Pieris 'Flaming Silver', plus Hydrangea 'Bloody Marie', Euphorbia 'Ascot Petite' and a spare Little Devil; the Honeysuckle was removed.",
  ...
  const BED_PLANT_MAPS = {
    ...
    frontBed4: [
      { name: "The Pilgrim", x: 12, y: 26, r: 11, hue: 55 },
      { name: "Physocarpus Cluster 1 (2 × Little Devil)", x: 24, y: 30, r: 8, hue: 345 },
      { name: "Physocarpus Cluster 2 (2 × Lady in Red)", x: 36, y: 28, r: 8, hue: 350 },
      { name: "Rhododendron 'Libretto'", x: 46, y: 24, r: 14, hue: 280 },
      { name: "Magic Carpet", x: 39, y: 45, r: 8, hue: 70 },
      { name: "Physocarpus Cluster 3 (2 × Little Devil + 1 × Lady in Red)", x: 64, y: 28, r: 9, hue: 348 },
      { name: "Purple Gem", x: 62, y: 48, r: 7, hue: 115 },
      { name: "Photinia (existing canopy)", x: 78, y: 30, r: 18, hue: 112 },
      { name: "Festuca 'Elijah Blue' (3 plants)", x: 33, y: 65, r: 12, hue: 215 },
      { name: "Dahlia 'Tampico'", x: 65, y: 68, r: 12, hue: 5 },
      { name: "Verbena 'Margaret's Memory'", x: 54, y: 79, r: 7, hue: 330 },
      { name: "Delosperma 'Ice Cream Mix'", x: 80, y: 78, r: 7, hue: 20 },
      { name: "Pieris 'Polar Passion'", x: 81, y: 57, r: 10, hue: 345 },
      { name: "The Generous Gardener", x: 90, y: 55, r: 11, hue: 345 },
      { name: "Achillea", x: 18, y: 78, r: 9, hue: 15 },
    ],
    frontBed5: [
      ...
      { name: "Hydrangea 'Bloody Marie'",              x: 73, y: 34, r: 9, hue: 345 },
      { name: "Euphorbia 'Ascot Petite'",              x: 91, y: 42, r: 7, hue: 80 },
      ...
      { name: "Astrantia trio",                        x: 74, y: 72, r: 7, hue: 335 },
      { name: "Flaming Silver",                        x: 88, y: 75, r: 7, hue: 85 },
