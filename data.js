...
window.OAK = (function () {
  ...
  const ZONES = {
    ...
    littlepot1: {
      ...
      desc:
        "A small blue pot shifted farther south along the right edge of the steps in August 2026. It now holds Helleborus Ice N' Roses Bennotta; its earlier Geranium and Petunia display remains in the September journal.",
    ...
    baskets: {
      ...
      desc:
        "Three individually recorded hanging baskets: red Basket 1 and green Basket 2 hang in Patio Kitchen & Lounge, while purple Basket 3 has moved to the Decking section.",
  ...
  const PLANTS = {
    ...
    "Little Pot 1": [
      {
        name: "Helleborus Ice N' Roses Bennotta",
        id: "littlepot1-hellebore-ice-n-roses-bennotta",
        latin: "Helleborus × glandorfensis 'COSEH 6600'",
        photos: ["images/September Hanging Baskets & Pots/Little Pot 1 - Helleborus - 1.jpeg", "images/September Hanging Baskets & Pots/Little Pot 1 - Helleborus - 2.jpeg"],
        position: "Single winter-flowering centrepiece — planted September 2026",
        light: "Partial shade to sun in a sheltered position.",
        water: "Keep compost evenly moist but freely drained; do not leave the crown waterlogged.",
        care: "Remove tired leaves and faded flower stems in spring. Wear gloves when handling, and raise the pot so winter rain drains freely.",
        seasonal: "Deep pink to red outward-facing flowers from winter into spring above evergreen foliage.",
      },
    ],
    "Little Pot 2": [
      {
    ...
    "Wall Pot 1": [
      {
        ...
        id: "wallpot1-phormium-flamingo",
        latin: "Phormium 'Flamingo'",
        photos: ["images/September Hanging Baskets & Pots/Phorium - 1.jpeg", "images/September Hanging Baskets & Pots/Phorium - 2.jpeg", "images/September Hanging Baskets & Pots/Phorium - 3.jpeg"],
        position: "Former Candy House Calibrachoa pot on the steps — planted September 2026",
        light: "Full sun for strongest foliage colour; shelter from severe cold wind.",
        water: "Water while establishing, then let the upper compost dry slightly; never leave the pot waterlogged.",
        care: "Remove only damaged leaves at the base. Raise the pot for winter drainage and protect the crown during severe frost.",
        seasonal: "Evergreen, pink-striped sword-like leaves give year-round structure.",
      },
    ],
    "Wall Pot 2": [
      {
    ...
    "Baskets": [
      ...
      },
      {
        ...
        position: "Purple Basket 3 — moved from the Lounge Door to the Decking section in September 2026",
      ...
      },
      {
        ...
        photos: ["images/September Hanging Baskets & Pots/Hanging Basket 1 & 2 - Heather.jpeg"],
        position: "One plant in each of red Basket 1 and green Basket 2 — Patio Kitchen & Lounge",
        light: "Full sun to light partial shade.", water: "Keep compost lightly moist while establishing; never waterlog.",
        care: "Use free-draining, preferably ericaceous compost. Trim lightly after flowering, never into bare wood.",
        seasonal: "Evergreen foliage and late-summer to autumn colour.",
      },
      {
        name: "Viola 'Rocky Purple Picotee' (2 plants)",
        id: "baskets-viola-rocky-purple-picotee",
        latin: "Viola cornuta 'Rocky Purple Picotee'",
        position: "One plant in each of red Basket 1 and green Basket 2 — Patio Kitchen & Lounge",
        light: "Sun to partial shade.", water: "Keep compost evenly moist, particularly in windy weather.",
        care: "Deadhead faded flowers and seed pods to extend the display.",
        seasonal: "Purple flowers with a pale picotee edge through the cool season.",
      },
      {
        name: "Hedera helix 'Yellow Ripple' (2 plants)",
        id: "baskets-hedera-yellow-ripple",
        latin: "Hedera helix 'Golden Starlight' (Yellow Ripple)",
        photos: ["images/September Hanging Baskets & Pots/Hanging Basket 1 & 2 - Ivy.jpeg"],
        position: "One trailing plant in each of red Basket 1 and green Basket 2 — Patio Kitchen & Lounge",
        light: "Shade to sun; avoid prolonged scorching sun on pale foliage.", water: "Keep the shared basket compost evenly moist and well drained.",
        care: "Trim trails to shape and keep stems clear of neighbouring crowns.",
        seasonal: "Evergreen variegated trails give structure through winter.",
      },
      {
        name: "Pansy 'Fire' (2 plants)",
        id: "baskets-pansy-fire",
        latin: "Viola × wittrockiana 'Fire'",
        position: "One plant in each of red Basket 1 and green Basket 2 — Patio Kitchen & Lounge",
        light: "Sun to partial shade.", water: "Keep evenly moist but never saturated.",
        care: "Remove faded flowers and seed pods regularly.",
        seasonal: "Cool-season flowers provide autumn-to-spring colour.",
      },
      {
        name: "Pansy 'Rose Surprise' (2 plants)",
        id: "baskets-pansy-rose-surprise",
        latin: "Viola × wittrockiana 'Rose Surprise'",
        position: "One plant in each of red Basket 1 and green Basket 2 — Patio Kitchen & Lounge",
        light: "Sun to partial shade.", water: "Keep evenly moist but never saturated.",
        care: "Remove faded flowers and seed pods regularly.",
        seasonal: "Cool-season flowers provide autumn-to-spring colour.",
    ...
    "Front Bed 4": [
      ...
      },
      {
        ...
        position: "Former Delosperma pocket near the established canopy — two plants remain after one moved to a hanging basket in September 2026",
        ...
        seasonal: "A two-plant mixed Calluna group with pink, white and lime-green flower-and-foliage interest from late summer into autumn.",
      },
    ],
    "Front Bed 5": [
      {
      ...
      {
        name: "Viola 'Rocky Purple Picotee'",
        id: "frontBed5-viola-rocky-purple-picotee",
        latin: "Viola cornuta 'Rocky Purple Picotee'",
        photos: ["images/September Hanging Baskets & Pots/Front Bed 5 - Update 1.jpeg", "images/September Hanging Baskets & Pots/Front Bed 5 - Update 2.jpeg"],
        position: "Beside the Astrantia trio and Heather 'Winter Chocolate' — added September 2026",
        light: "Sun to partial shade.", water: "Keep evenly moist while establishing; do not allow the planting pocket to become waterlogged.",
        care: "Deadhead faded flowers and seed pods regularly to prolong the cool-season display.",
        seasonal: "Purple flowers with pale picotee margins through autumn, winter and spring.",
      },
      {
        name: "Ceratostigma",
  ...
  PLANTS["Skimmia Pot"] = [
    ...
    {
      name: "Skimmia 'Antarctica'",
      id: "lobeliapot-skimmia-antarctica",
      latin: "Skimmia 'Antarctica'",
      photos: ["images/September Hanging Baskets & Pots/Skimmia Pot - Update 1.jpeg", "images/September Hanging Baskets & Pots/Skimmia Update - 2.jpeg"],
      position: "Second evergreen Skimmia in the pot — added September 2026",
      light: "Partial to full shade, sheltered from harsh sun and drying wind.", water: "Keep compost evenly moist and freely drained; rainwater is preferred where practical.",
      care: "Use ericaceous compost and prune only lightly after flowering. Do not let the root ball dry out while establishing.",
      seasonal: "Glossy evergreen foliage and spring flower buds give year-round structure.",
    },
    {
      name: "Viola 'Rocky Purple Picotee' (3 plants)",
      id: "lobeliapot-viola-rocky-purple-picotee",
      latin: "Viola cornuta 'Rocky Purple Picotee'",
      position: "Three plants around the Skimmias — added September 2026",
      light: "Sun to partial shade.", water: "Keep the shared compost evenly moist but well drained.",
      care: "Deadhead faded flowers and seed pods regularly to prolong flowering.",
      seasonal: "Purple flowers with pale picotee margins through the cool season.",
    },
  ];
  ...
  const PROFILE_OVERRIDES = {
    ...
    "Calluna Trio Mix (2 plants)": { habit: "Low evergreen heather group", size: "About 25–45cm high and wide per plant", hardiness: "H5–H6 · hardy in most UK gardens", wildlife: "Late-season flowers visited by pollinators" },
  ...
  const PHOTOS_BY_MONTH = {
    ...
    "sep-2026": {
      ...
      littlepot1Archive: [
        { src: "images/September Hanging Baskets & Pots/Little Pot 1 - Before being removed.jpeg", caption: "Little Pot 1 before its Geranium and Petunia were removed" },
      ],
      wallpot1: [
        { src: "images/September Hanging Baskets & Pots/Phorium - 1.jpeg", caption: "Phormium 'Flamingo' in the former Calibrachoa pot" },
        { src: "images/September Hanging Baskets & Pots/Phorium - 2.jpeg", caption: "Pink-striped foliage in the Steps wall pot" },
      ],
      wallpot1Archive: [
        { src: "images/September Hanging Baskets & Pots/Calibrachoa Pot Before Being Removed.jpeg", caption: "Candy House Calibrachoa before replacement" },
      ],
      lobeliapot: [
        { src: "images/September Hanging Baskets & Pots/Skimmia Pot - Update 1.jpeg", caption: "Skimmia Pot with its September additions" },
        { src: "images/September Hanging Baskets & Pots/Skimmia Update - 2.jpeg", caption: "Skimmias and Rocky Purple Picotee Violas together" },
      ],
      baskets: [
      ...
      frontBed5: [
        ...
        { src: "images/September Hanging Baskets & Pots/Front Bed 5 - Update 2.jpeg", caption: "Front Bed 5 September update" },
      ],
    },
  };
  ...
  const BED_PLANT_MAPS = {
    ...
    littlepot1: [
      { plantId: "littlepot1-hellebore-ice-n-roses-bennotta", name: "Helleborus Ice N' Roses Bennotta", x: 50, y: 50, r: 34, hue: 345 },
    ],
    littlepot2: [
    ...
    lobeliapot: [
      ...
      { plantId: "lobeliapot-skimmia-antarctica", name: "Skimmia 'Antarctica'", x: 66, y: 42, r: 20, hue: 120 },
      { plantId: "lobeliapot-viola-rocky-purple-picotee", name: "Viola 'Rocky Purple Picotee' (3 plants)", x: 52, y: 72, r: 18, hue: 290 },
    ],
    bed23wallpot: [
    ...
    wallpot1: [
      { plantId: "wallpot1-phormium-flamingo", name: "Phormium 'Flamingo'", x: 50, y: 50, r: 36, hue: 340 },
    ],
    wallpot2: [
