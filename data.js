...
window.OAK = (function () {
  ...
  const BED_PLANT_MAPS = {
    ...
    frontBed5: [
      { mapNo: 1,  plantId: "frontBed5-bluebell-creeper-sollya",           name: "Bluebell Creeper",                     x: 96, y: 3,  r: 4,   hue: 240 },
      { mapNo: 2,  plantId: "frontBed5-heather-bells-extra-special",       name: "Heather 'Bell's Extra Special'",       x: 81, y: 3,  r: 4,   hue: 75  },
      { mapNo: 3,  plantId: "frontBed5-heather-tib",                       name: "Heather 'Tib'",                        x: 81, y: 8,  r: 4,   hue: 325 },
      { mapNo: 4,  plantId: "frontBed5-ceratostigma-plumbaginoides",       name: "Ceratostigma",                         x: 88, y: 14, r: 4.5, hue: 235 },
      { mapNo: 5,  plantId: "frontBed5-bell-heather-providence",           name: "Bell Heather 'Providence' (2 plants)", x: 96, y: 18, r: 4.5, hue: 335 },
      { mapNo: 6,  plantId: "frontBed5-hebe-rhubarb-and-custard",          name: "Hebe 'Rhubarb and Custard'",           x: 96, y: 29, r: 4.5, hue: 340 },
      { mapNo: 7,  plantId: "frontBed4-flaming-silver",                    name: "Flaming Silver",                       x: 90, y: 24, r: 4,   hue: 85  },
      { mapNo: 8,  plantId: "frontBed5-ceratostigma-plumbaginoides",       name: "Ceratostigma",                         x: 74, y: 28, r: 8,   hue: 235 },
      { mapNo: 9,  plantId: "frontBed5-heather-leprechaun",                name: "Heather 'Leprechaun'",                 x: 58, y: 30, r: 4,   hue: 95  },
      { mapNo: 10, plantId: "frontBed5-hypericum-cultivar-to-confirm",      name: "Hypericum (cultivar to confirm)",      x: 56, y: 35, r: 7.5, hue: 55 },
      { mapNo: 11, plantId: "frontBed4-astrantia-trio",                    name: "Astrantia trio",                       x: 87, y: 34, r: 4,   hue: 335 },
      { mapNo: 12, plantId: "frontBed5-bell-heather-providence",           name: "Bell Heather 'Providence' (2 plants)", x: 78, y: 38, r: 4.5, hue: 335 },
      { mapNo: 13, plantId: "frontBed5-salvia-salgoon-lake-blueberry",      name: "Salvia 'Salgoon Lake Blueberry'",      x: 83, y: 47, r: 9,   hue: 270 },
      { mapNo: 14, plantId: "frontBed5-little-devil",                      name: "Little Devil",                         x: 95, y: 37, r: 4,   hue: 345 },
      { mapNo: 15, plantId: "frontBed5-heather-winter-chocolate",          name: "Heather 'Winter Chocolate'",           x: 54, y: 42, r: 4,   hue: 45  },
      { mapNo: 16, plantId: "frontBed5-gaura-gaudi-red",                   name: "Gaura 'Gaudi Red'",                    x: 54, y: 50, r: 7,   hue: 350 },
      { mapNo: 17, plantId: "frontBed5-euphorbia-ascot-petite",            name: "Euphorbia 'Ascot Petite'",             x: 32, y: 49, r: 6,   hue: 80  },
      { mapNo: 18, plantId: "frontBed5-hydrangea-bloody-marie",            name: "Hydrangea 'Bloody Marie'",             x: 10, y: 47, r: 8,   hue: 345 },
      { mapNo: 19, plantId: "frontBed5-pittosporum-tom-thumb",             name: "Pittosporum 'Tom Thumb'",              x: 17, y: 64, r: 8,   hue: 320 },
      { mapNo: 20, plantId: "frontBed5-bay-tree",                          name: "Bay Tree",                             x: 47, y: 59, r: 14,  hue: 125 },
      { mapNo: 21, plantId: "frontBed5-japanese-skimmia",                  name: "Japanese Skimmia",                     x: 54, y: 74, r: 10,  hue: 120 },
      { mapNo: 22, plantId: "frontBed5-mexican-orange-blossom",            name: "Mexican Orange Blossom",               x: 65, y: 89, r: 16,  hue: 70  },
      { mapNo: 23, plantId: "frontBed5-hardy-fuchsia",                     name: "Hardy Fuchsia (cultivar to confirm)",  x: 86, y: 69, r: 11,  hue: 335 },
      { mapNo: 24, plantId: "frontBed5-clematis",                          name: "Clematis (cultivar to confirm)",       x: 90, y: 90, r: 7,   hue: 285 },
    ],
    frontPots: [
