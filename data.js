...
window.OAK = (function () {
  ...
  const ZONES = {
    ...
    baskets: {
      ...
      desc:
        "One paired winter-basket collection: red Basket 1 and green Basket 2 are planted alike with Calluna, Viola, Hedera and two Pansies, and hang in Patio Kitchen & Lounge.",
    ...
    "Baskets": [
      {
        ...
        group: "Shared planting · red Basket 1 & green Basket 2",
