...
window.OAK = (function () {
  ...
  const ZONES = {
    ...
    frontBed3: {
      ...
      desc:
        "The house-wall bed running under the Bedroom 3 and Bedroom 1 windows, up to the vertical line between the Bedroom 1 window and the ensuite where Bed 4 takes over. Climbing roses cover the wall, with the relocated variegated dogwood and Red Hot Poker plus Leucothoe 'Little Flames' below. Cercis canadensis 'Eternal Flame' was planted at the Bedroom 3 end in September 2026.",
    ...
    frontArbutus: {
      id: "frontArbutus",
      title: "Front · Strawberry Tree",
      badge: "Arbutus specimen",
      dims: "Young tree · position marked September 2026",
      where: "Beside the skinny brick wall, between the Patio and Stone Trough",
      desc: "Arbutus unedo, the evergreen Strawberry Tree, planted at the marked front-garden position in September 2026.",
      shape: { kind: "circle", cx: 558, cy: 272, r: 18 },
      color: "#6d7d42",
      labelXY: [570, 264],
      plantKey: "Front Strawberry Tree",
    },
    frontBoxHedge: {
      id: "frontBoxHedge",
  ...
  const PLANTS = {
    ...
    "Bed 4": [
      ...
      },
      {
        ...
        id: "bed4-abelia-radiance",
        latin: "Abelia × grandiflora 'Radiance'",
        photos: ["images/September Trees & Pots /Bed 4 - Abelia grandiflora 'Radiance' - 1.jpeg", "images/September Trees & Pots /Bed 4 - Abelia grandiflora 'Radiance' - 2.jpeg"],
        position: "Back Bed 4 — added September 2026",
        light: "Full sun to partial shade; foliage colour is strongest with good light.",
        water: "Water deeply while establishing, then only in prolonged dry spells. Keep the root zone freely drained.",
        care: "Mulch while it settles, keeping mulch clear of the stems. Prune lightly after flowering to maintain a compact framework; remove winter-damaged tips in spring.",
        seasonal: "Variegated green, cream and yellow foliage carries warm pink-red tones in cooler weather; small white summer flowers; semi-evergreen in mild winters.",
      },
      {
        name: "Celosia",
        id: "bed4-celosia",
    ...
    "Hanging Basket 3": [
      {
        ...
        latin: "Fuchsia hybrid",
        photos: ["images/September Trees & Pots /Hanging Basket 3 - 1.jpeg"],
        group: "Hanging Basket 3 · retained September 2026",
        position: "Retained in the refreshed Hanging Basket 3 on the Decking",
        light: "Bright shade to morning sun; shelter from harsh reflected afternoon heat.",
        water: "Keep the basket compost evenly moist and freely drained.",
        care: "Deadhead flowers and developing berries; pinch or shorten long bare shoots to keep the basket balanced.",
        seasonal: "Pendant flowers through the mild season; protect from frost if the plant is to be retained.",
      },
      {
        name: "Fern (cultivar to confirm)",
        id: "baskets-fern-unidentified",
        latin: "Fern — cultivar to confirm",
        photos: ["images/September Trees & Pots /Hanging Basket 3 - 1.jpeg"],
        group: "Hanging Basket 3 · retained September 2026",
        position: "Retained in the refreshed Hanging Basket 3 on the Decking",
        light: "Bright shade to partial shade; avoid hot, drying sun until the fern is identified.",
        water: "Keep compost evenly moist but never saturated.",
        care: "Remove damaged fronds at the base and protect the crown from prolonged winter wet. Retain a label or a close frond photograph for identification.",
        seasonal: "Foliage interest; hardiness and winter behaviour remain to be confirmed from the cultivar.",
      },
      {
        name: "Lysimachia (cultivar to confirm)",
        id: "baskets-lysimachia-unidentified",
        latin: "Lysimachia — cultivar to confirm",
        photos: ["images/September Trees & Pots /Hanging Basket 3 - 2.jpeg"],
        group: "Hanging Basket 3 · added September 2026",
        position: "Trailing addition to the refreshed Hanging Basket 3 on the Decking",
        light: "Sun to partial shade.", water: "Keep compost evenly moist while establishing.",
        care: "Trim trailing growth to shape and avoid letting it smother the retained plants.",
        seasonal: "Fresh foliage is expected to trail through the basket; exact cultivar and winter behaviour remain to be confirmed.",
      },
      {
        name: "Chrysanthemum (cultivar to confirm)",
        id: "baskets-chrysanthemum-unidentified",
        latin: "Chrysanthemum — cultivar to confirm",
        photos: ["images/September Trees & Pots /Hanging Basket 3 - 2.jpeg"],
        group: "Hanging Basket 3 · added September 2026",
        position: "Flowering addition to the refreshed Hanging Basket 3 on the Decking",
        light: "Sun to partial shade.", water: "Keep compost moist but well drained; do not leave the basket standing wet.",
        care: "Remove spent flowers and damaged leaves. Treat hardiness as unknown until a label confirms the cultivar.",
        seasonal: "Autumn flowers provide late colour; cultivar and overwintering potential are unconfirmed.",
      },
      {
        name: "Cyclamen (cultivar to confirm)",
        id: "baskets-cyclamen-unidentified",
        latin: "Cyclamen — cultivar to confirm",
        photos: ["images/September Trees & Pots /Hanging Basket 3 - 3.jpeg"],
        group: "Hanging Basket 3 · added September 2026",
        position: "Autumn addition to the refreshed Hanging Basket 3 on the Decking",
        light: "Bright, sheltered partial shade.", water: "Water the compost sparingly around the edge, avoiding a saturated crown.",
    ...
    "Front Bed 3": [
      {
        name: "Cercis 'Eternal Flame'",
        id: "frontBed3-cercis-eternal-flame",
        latin: "Cercis canadensis 'Eternal Flame' ('Nc2016-2')",
        photos: ["images/September Trees & Pots /Cercis - Eternal Flame - 1.jpeg", "images/September Trees & Pots /Cercis - Eternal Flame - 2.jpeg", "images/September Trees & Pots /Cercis - Eternal Flame - 3.jpeg", "images/September Trees & Pots /Cercis - Eternal Flame - 4.jpeg", "images/September Trees & Pots /Cercis - Eternal Flame - 5.jpeg"],
        position: "Bedroom 3 end of Front Bed 3 — red circle in the September plan",
        light: "Full sun in fertile, moisture-retentive but well-drained soil.",
        water: "Water deeply through dry spells for the first two growing seasons; do not leave the root zone waterlogged.",
        care: "Keep a weed-free mulched circle, avoid hard pruning and stake only while the young tree establishes. Check leaves and stems for scale or stress before treating.",
        seasonal: "Glossy young foliage opens red and matures through orange and yellow tones; mature trees flower pink on bare stems in spring; deciduous in winter.",
      },
      {
  ...
  const PHOTOS_BY_MONTH = {
    ...
    "sep-2026": {
      ...
      frontBed3: [
        ...
        { src: "images/September Trees & Pots /Cercis - Eternal Flame - 2.jpeg", caption: "New Cercis 'Eternal Flame' foliage" },
      ],
      frontArbutus: [
  ...
  const BED_PLANT_MAPS = {
    ...
    frontBed3: [
      ...
      { plantId: "frontBed3-cercis-eternal-flame", name: "Cercis 'Eternal Flame'", x: 12, y: 26, r: 13, hue: 15 },
